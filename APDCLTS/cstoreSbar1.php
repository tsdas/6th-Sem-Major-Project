<div class="w3-sidebar  w3-opacity-min w3-indigo w3-padding w3-rightbar" style="width:300px;">
    <div class="w3-center">
    ...
    <div class="w3-bar-block">
        <a href="cstoreHome.php" class="w3-bar-item w3-button left"><i class="fa fa-home menu-icon"></i> Central Storage Home  <i class="fa fa-caret-right w3-right" style="padding-top:5px;"></i></a>
        ...
        <a onClick="supenu();" class="w3-bar-item w3-button"><i class="fa fa-cart-plus menu-icon"></i> Supply <i class="fa fa-caret-down w3-right" style="padding-top:5px;"></i></a>
            <div id="smenu" style="display:none;" class="w3-container w3-bar-block">
                ...
                <a href="viewsupply.php" class="w3-bar-item w3-button"><i class="fa fa-hand-o-right"></i> View Supplied Materials</a>
            </div>    

 		  <a href="requestRcstore.php" class="w3-bar-item w3-button left"><i class="fa fa-list menu-icon"></i> View Requisition <i class="fa fa-caret-right w3-right" style="padding-top:5px;"></i></a>
