...
<body>
    ...
    <div style="margin-left:300px;">
        ...
        <div class="container" style="width:90%; margin:16px auto;">
            <h3 align="center" class="bottombar">Sub Division Wise Requisition Details</h3>
            <form id="form1" method="post" action="sdivReqGra.php">
            	<p>
            ...
            <div class="container card-2 white padding-16">
            	<?php
					...
					{
						$sdiv=$_POST["sdiv"];
						$str="Select A.*,SUM(quantity) as quantity,C.mname from requisition as A,reqdetails as B,materials as C where A.sdiv='$sdiv' and B.mid=C.mid and A.rno=B.rno GROUP BY B.mid";
						$result = mysqli_query($link,$str);
