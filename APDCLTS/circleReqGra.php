        ...
        <div class="row-padding padding-16">
        	<div class="third">
            	<?php
						...
						$str="Select A.*,SUM(quantity) as quantity,C.mname from requisition as A,reqdetails as B,materials as C where A.sdiv='$div' and B.mid=C.mid and A.rno=B.rno GROUP BY B.mid";
                    ...
                    <p align="center"><a href="sdivReqCir.php?div=<?php echo $div; ?>" class="btn blue">View Sub-Division Requisition</a></p>
            </div>
            <div class="third">
            	<?php
