...
<head>
<meta charset="utf-8">
<meta http-equiv="refresh" content="3;URL='cstoreHome.php'">
<title>APDCL</title>
            ...
            <div class="row-padding">
                ...
                <div class="quarter">
                    <div class="container padding-16 lime center">
                        ...
                        Materials Stock</a> &nbsp;
                        <?php
                            $sql="Select * from storage where dept='Central Store'";
                            $result=mysqli_query($link,$sql);
                            $row=mysqli_num_rows($result);
                            $n=$row;
                        ?>
                ...
                <div class="quarter">
                    <div class="container padding-16 green center">
                         ...
                         <a href="requestRcstore.php" style="text-decoration:none;"> <img src="images/request.png" style="width:50%;"><br>Requisitions Received</a>&nbsp;
                         <?php
                            $sql="Select distinct rno from reqdetails where status='C Store'";
                            $result=mysqli_query($link,$sql);
                            $row=mysqli_num_rows($result);
                            $n=$row;
                        ?>
                ...
                <div class="quarter">
                    <div class="container padding-16 yellow center">
                        ...
                        Supply Record</a> &nbsp;
                         <?php
                            $sql="Select * from msupply where dept='Central Store'";
                            $result=mysqli_query($link,$sql);
                            $row=mysqli_num_rows($result);
                            $n=$row;
                        ?>
