                    	...
                    	<table class="table-all">
                            ...
                            <tbody>
                            	<?php
									...
									$sql="Select A.*,B.status from requisition as A,reqdetails as B where B.status='C Store' and A.rno=B.rno GROUP BY B.rno";
									...
									while($row=mysqli_fetch_array($result))
									{
										...
										echo '<td>'.$row[4].'</td>';
										echo '<td><a href="viewRdetailsCStore.php?id='.$row[0].'" class="btn blue round small">Click Here</a></td>';
										echo '</tr>';	
									}
								?>
                            </tbody>
