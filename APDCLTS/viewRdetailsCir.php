       ...
       <?php
        ...
        <div class="container" style="width:90%; margin:24px auto;">
				<div class="card white" style="width:80%; margin:0 auto;">
                    ...
                    <div class="container padding-16">
                    	<form id="form1" name="form1" method="post" action="processCirRequest.php">
                    	...
                    	<table class="table-all">
                            ...
                            <tbody>
                            	<?php
									$sql="Select A.*,B.mname from reqdetails as A,materials as B where A.status='Circle' and A.rno='$rid' and A.mid=B.mid";
									$result=mysqli_query($link,$sql);
