    	...
    	<div class="w3-card-2 w3-white w3-opacity-min" style="width:60%; margin:120px auto">
            ...
            <div class="w3-container w3-padding-16">
            	<form name="form3" id="form3" method="post" action="postrequis.php">
                    ...
                    <p>
                        <select name="division" class="w3-select w3-border w3-round-medium">
                    ...
                    <p>
                        <select name="subdivi" class="w3-select w3-border w3-round-medium">

                        <option selected>Select Requested Sub-Division Name</option>
