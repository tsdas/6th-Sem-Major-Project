    ...
    <div style="margin-left:300px;">
        ...
        <div class="w3-card-2 w3-white w3-opacity-min" style="width:60%; margin:120px auto">
        	<div class="w3-container">
            	<div class="left"><h3 class="bottombar">View Vendors</h3></div>
                <div class="right" style="padding-top:16px;"><a href="newvendors.php" class="btn black round small text-white"><i class="fa fa-plus-square"></i> Add New</a></div>
            </div>
