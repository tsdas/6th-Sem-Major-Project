      ...
      <div class="w3-container w3-indigo w3-right-align w3-opacity-min">
    	...
    	<div class="w3-card-2 w3-white w3-opacity-min" style="width:60%; margin:32px auto">
        	<div class="w3-container">
              <div class="left"><h3 class="bottombar">View Repairing Cost</h3></div>
                    ...
                    <table class="w3-table-all">
                            ...
                            <tbody>
                                <?php
										...
										$sql="Select A.*,B.dept,C.mname,D.name from repaired as A,repairing as B,materials as C,vendors as D where A.rid=B.rid and B.mid=C.mid and B.dept='$deptid' and A.vendor=D.vid";	
